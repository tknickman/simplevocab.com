...
//   April 27, 2011, 2:17 am with psd2css Online version 1.95
...
$(document).ready(function(){
  ...
  $("#Layer-55").addClass("Wrap-51-55").hide();
  $("#Layer-51").addClass("Wrap-51-55");
  $(".Wrap-51-55").hover(
    function(){ $("#Layer-55").show(); $("#Layer-51").hide(); },
    function(){ $("#Layer-51").show(); $("#Layer-55").hide(); });
