...
//   April 27, 2011, 3:31 pm with psd2css Online version 1.95
...
$(document).ready(function(){
  ...
  $("#Layer-58").addClass("Wrap-53-58").hide();
  $("#Layer-53").addClass("Wrap-53-58");
  $(".Wrap-53-58").hover(
    function(){ $("#Layer-58").show(); $("#Layer-53").hide(); },
    function(){ $("#Layer-53").show(); $("#Layer-58").hide(); });
